...
public class AccountsList {
    ...
    private static MyBusinessAccountManagement mybusinessaccount;
    ...
    private static Credential authorize() throws Exception {
        ...
        InputStream secrets = AccountsList.class.getResourceAsStream("client_secrets.json");
    ...
    public static void main(String[] args) throws Exception {
        ...
        mybusinessaccount = new MyBusinessAccountManagement.Builder(httpTransport, JSON_FACTORY, credential)
            .setApplicationName(APPLICATION_NAME).build();

        // Uses the 'mybusiness' instance to send an API call.
        MyBusinessAccountManagement.Accounts.List accountsList = mybusinessaccount.accounts().list();
